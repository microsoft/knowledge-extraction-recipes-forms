...
namespace FrequentTerms
{
    ...
    public static class FunctionExtract
    {
            ...
            ILogger log)
        {
            ...
            List<string> customwords = new List<string> { "marie", "curie", "curies", "pierre", "ir�ne ", "irene", "new", "time", "also", "one", "name", "work", "first", "became", "began", "work", "working", "must", "left", "could", "never", "life", "died", "found", "set", "still", "awarded", "worked", "used", "called", "rosalind", "franklin" };
